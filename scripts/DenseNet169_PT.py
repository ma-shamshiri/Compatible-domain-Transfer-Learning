...
for layer in conv_base.layers:
    if layer.name == 'conv5_block30_0_bn':
        set_trainable = True
    if set_trainable:
...
base_model.load_weights('/home/m_hamshi/models/weights_Dense_none.h5')
...
predictions = base_model.predict_generator(validation_generator, steps=20)
val_preds = predictions
val_trues = validation_generator.classes

predictions = base_model.predict_generator(test_generator, steps=80)
test_preds = predictions
test_trues = test_generator.classes

# base_model.save_weights("/home/m_hamshi/models/weights_Dense_histo.h5")
