...
conv_base = InceptionV3(weights=None, include_top=True,
...
base_model.load_weights('/home/m_hamshi/models/weights_IRV3_none.h5')
...
base_model.save_weights("/home/m_hamshi/models/weights_IRV3_histo.h5")
