...
# base_dir = "/home/m_hamshi/Dataset/ToyDataset/"
...
conv_base = DenseNet169(weights=None, include_top=True,
...
#     if layer.name == 'conv3_block10_0_bn':
#         set_trainable = True
#     if set_trainable:
...
base_model.save_weights("/home/m_hamshi/models/weights_Dense_Pre.h5")
...
def plot_roccurve():
    ...
    # print(f"len(val_trues): {len(val_trues)}")
    # print(f"type(val_trues): {type(val_preds)}")
    # print(f"len(val_preds): {len(val_preds)}")
    # print(f"type(val_preds): {type(val_preds)}")
    # print(f"len(fpr): {len(fpr)}")
    # print(f"type(fpr): {type(fpr)}")
    # print(f"len(tpr): {len(tpr)}")
    # print(f"type(tpr): {type(tpr)}")
    # print(f"len(thresholds): {len(thresholds)}")
    # print(f"type(thresholds): {type(thresholds)}")
